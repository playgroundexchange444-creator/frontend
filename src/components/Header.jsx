    ...
    return (
        <>
                                ...
                                <Link
                                    ...
                                    className={[
                                        ...
                                        isActive(it.to)
                                            ...
                                            : "border-yellow-400/40 hover:bg-yellow-400 hover:text-black",
                                    ].join(" ")}
                                >
                                    {it.label}
                                </Link>
                    ...
                    <div className="md:hidden border-t border-gray-800 bg-gray-900/95 backdrop-blur">
                        <div className="px-3 py-2 flex flex-col gap-2">
                            ...
                            <button
                                ...
                                className="px-3 py-2 rounded text-sm border border-yellow-400/40 hover:bg-yellow-400 hover:text-black transition text-left"
                            >
            ...
            >
                ...
                <aside
                    className={[
                        "absolute right-0 top-0 h-full w-[92%] sm:w-[420px] bg-[#0b0d17] border-l border-gray-800 shadow-2xl transition-transform duration-300",
